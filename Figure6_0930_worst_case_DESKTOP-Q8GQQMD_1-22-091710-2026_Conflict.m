...
for date = date_list
    ...
    set(fig2, 'Units','centimeters','Position',[5 15 19 4]);
    ...
    set(fig2, 'Units','centimeters','Position',[5 9 19 4]);
...
for i = 1:length(date_list)
    ...
    set(fig2, 'Units','centimeters','Position',[5+(i-1)*5 6 4 5]); 
    ...
    % Normal 데이터 점 찍기 (jitter 적용)
    x_norm = x_positions(1) + (rand(size(Normal{i})) - 0.5) * 2 * jitterAmount;
    scatter(x_norm, Normal{i}, 8, ...
        'MarkerFaceColor','w','MarkerEdgeColor','k','MarkerFaceAlpha',0.6);
    
    % OAB Before 데이터 점 찍기 (jitter 적용)
    x_oab = x_positions(2) + (rand(size(OAB{i})) - 0.5) * 2 * jitterAmount;
    scatter(x_oab, OAB{i}, 8, ...
        'MarkerFaceColor','w','MarkerEdgeColor','k','MarkerFaceAlpha',0.6);
    
    % OAB After 데이터 점 찍기 (jitter 적용)
    x_tns = x_positions(3) + (rand(size(TNS{i})) - 0.5) * 2 * jitterAmount;
    scatter(x_tns, TNS{i}, 8, ...
        'MarkerFaceColor','w','MarkerEdgeColor','k','MarkerFaceAlpha',0.6);
