...
for date = date_list
    ...
    set(fig2, 'Units','centimeters','Position',[5 13 4 3]);
    plot(plot_raw, 'k', 'linewidth', 1.2);
    axis tight
...
for i = 1:length(date_list)
    ...
    set(fig2, 'Units','centimeters','Position',[5+(i-1)*5 6 6 4]); 
...
set(fig3, 'Units','centimeters','Position',[5+(i-1)*5 6 12 4]); 
