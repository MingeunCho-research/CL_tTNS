...
% date_list = [0703]; % 0721 0723도 확인한다?
% date_list = 0728;
...
for date = date_list
    ...
    for exp_num = exp_list
        ...
        CL_data{date_idx, exp_idx} = downsample(movmean(Pupil.filt{date_idx, exp_idx},6), 10, 1);
        ...
        %% figure 2
        figure(); set(gcf, 'Units','centimeters','Position',[10 5 7 2.5]);
        plot(CL_data{date_idx, exp_idx}, 'color','k','linewidth',1.2);
        hold on;
        ...
        %% figure 3
        figure(); set(gcf, 'Units','centimeters','Position',[10 5 3.5 2.5]);
        plot(CL_data{date_idx, exp_idx}, 'color','k','linewidth',1.2);
        hold on;
        ...
        %% figure 4 - raw data
        figure(); set(gcf, 'Units','centimeters','Position',[10 5 3.5 2.5]);
        plot(Pupil.raw{date_idx, exp_idx}, 'color','k','linewidth',1.2);
        hold on;
